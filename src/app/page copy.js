...
//       { name: "Tarhaab", url: "https://tarhaab.com/" }
//     ],
//     highlights: [
...
//             <span className="bg-gradient-to-r from-blue-500 to-cyan-500 bg-clip-text text-transparent">{personalInfo.name.split(' ')[0]}</span>
//           </div>
...
//                   className={`text-base font-medium transition-colors relative py-1 ${activeSection === item.id ? 'text-blue-500' : 'text-slate-400 hover:text-blue-500'}`}
//                 >
//                   {item.name}
//                   {activeSection === item.id && <span className="absolute -bottom-1 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full"></span>}
//                 </button>
//               </li>
//             ))}
//           </ul>
...
//           {/* Mobile Menu Toggle */}
//           <button className="lg:hidden p-1.5 text-slate-400" onClick={() => setIsMenuOpen(!isMenuOpen)} aria-label="Toggle menu">
...
//                   <button
//                     onClick={() => scrollToSection(item.ref)}
//                     className={`text-lg font-medium transition-all p-2.5 rounded-lg w-full text-left ${activeSection === item.id ? 'text-blue-500 bg-blue-500/10' : 'text-slate-400 hover:text-blue-500 hover:bg-blue-500/10'}`}
//                   >
//                     {item.name}
//                   </button>
//                 </li>
...
//               <h3 className="flex items-center gap-3 text-xl font-bold mb-5 text-slate-100"><FileCode size={24} /> Languages</h3>
//               <div className="flex flex-wrap gap-3">
//                 {skills.languages.map((skill, index) => (
//                   <span key={index} className="px-5 py-2.5 bg-blue-500/10 rounded-full text-sm font-medium border border-blue-500/20 text-slate-200 hover:bg-gradient-to-r hover:from-blue-500 hover:to-cyan-500 hover:text-white hover:-translate-y-0.5 hover:shadow-md hover:shadow-blue-500/30 transition-all cursor-default">{skill}</span>
//                 ))}
//               </div>
//             </div>
//             <div className="bg-slate-900 p-8 rounded-2xl border border-blue-500/10 hover:border-blue-500/30 hover:-translate-y-1 hover:shadow-lg hover:shadow-black/30 transition-all">
//               <h3 className="flex items-center gap-3 text-xl font-bold mb-5 text-slate-100"><Layers size={24} /> Frameworks</h3>
//               <div className="flex flex-wrap gap-3">
...
//             </div>
//             <div className="bg-slate-900 p-8 rounded-2xl border border-blue-500/10 hover:border-blue-500/30 hover:-translate-y-1 hover:shadow-lg hover:shadow-black/30 transition-all">
//               <h3 className="flex items-center gap-3 text-xl font-bold mb-5 text-slate-100"><Database size={24} /> Databases</h3>
//               <div className="flex flex-wrap gap-3">
...
//             </div>
//             <div className="bg-slate-900 p-8 rounded-2xl border border-blue-500/10 hover:border-blue-500/30 hover:-translate-y-1 hover:shadow-lg hover:shadow-black/30 transition-all">
//               <h3 className="flex items-center gap-3 text-xl font-bold mb-5 text-slate-100"><Server size={24} /> DevOps & Cloud</h3>
//               <div className="flex flex-wrap gap-3">
...
//               <h3 className="flex items-center gap-3 text-xl font-bold mb-5 text-slate-100"><Code size={24} /> Tools & Concepts</h3>
//               <div className="flex flex-wrap gap-3">
...
//                     <span className="flex items-center gap-1.5 text-sm text-slate-400 whitespace-nowrap"><Calendar size={16} /> {exp.period}</span>
//                   </div>
//                   <p className="text-base text-blue-400 font-semibold mb-5">{exp.company} | {exp.location}</p>
//                   <ul className="list-none p-0">
//                     {exp.highlights.map((highlight, idx) => (
//                       <li key={idx} className="pl-6 mb-3 text-slate-400 leading-relaxed relative before:content-['✓'] before:absolute before:left-0 before:text-blue-400 before:font-bold">{highlight}</li>
//                     ))}
//                   </ul>
//                 </div>
//               </div>
...
//                   <span className="text-xs font-semibold text-blue-400 bg-blue-500/10 px-3 py-1.5 rounded-full border border-blue-500/20">{project.category}</span>
//                   <div className="flex gap-2.5 flex-wrap">
//                     {project.github && (
//                       <a href={project.github} target="_blank" rel="noopener noreferrer"
//                         className="w-9 h-9 flex items-center justify-center bg-blue-500/10 rounded-full text-blue-400 border border-blue-500/20 hover:bg-gradient-to-r hover:from-blue-500 hover:to-cyan-500 hover:text-white hover:-translate-y-0.5 hover:shadow-md hover:shadow-blue-500/30 transition-all"
//                         aria-label="GitHub">
//                         <Github size={18} />
//                       </a>
//                     )}
//                     {project.live && (
//                       // Handle both single string and array of links
//                       Array.isArray(project.live) ? (
//                         project.live.map((link, idx) => (
//                           <a key={idx} href={link.url} target="_blank" rel="noopener noreferrer"
//                             className="px-3 py-1.5 flex items-center gap-1.5 bg-blue-500/10 rounded-full text-blue-400 border border-blue-500/20 hover:bg-gradient-to-r hover:from-blue-500 hover:to-cyan-500 hover:text-white hover:-translate-y-0.5 hover:shadow-md hover:shadow-blue-500/30 transition-all text-xs font-medium"
...
//                     <span key={idx} className="text-[13px] px-3 py-1.5 bg-blue-500/10 text-slate-200 rounded-2xl font-medium border border-blue-500/20">{tech}</span>
//                   ))}
//                 </div>
//                 {project.highlights && (
//                   <ul className="list-none p-0 border-t border-blue-500/10 pt-5">
//                     {project.highlights.map((highlight, idx) => (
//                       <li key={idx} className="pl-6 mb-2.5 text-slate-400 leading-relaxed relative text-sm before:content-['✓'] before:absolute before:left-0 before:text-blue-400 before:font-bold">{highlight}</li>
//                     ))}
//                   </ul>
//                 )}
//               </div>
...
//       {/* Contact Section */}
//       <section ref={contactRef} className="py-24 px-6 bg-gradient-to-br from-slate-950 to-slate-900">
//         <div className="max-w-6xl mx-auto">
//           <div className="text-center mb-20">
//             <h2 className="text-5xl font-extrabold text-slate-100 mb-4 tracking-tight">Get In Touch</h2>
//             <div className="mx-auto w-24 h-1 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500"></div>
//             <p className="mt-6 text-lg text-slate-400 max-w-xl mx-auto">Feel free to reach out for collaborations or just a friendly chat.</p>
//           </div>
//           <div className="flex flex-col lg:flex-row justify-between max-w-4xl mx-auto gap-16">
//             <div className="space-y-10">
//               <div className="flex items-center gap-6">
//                 <div className="bg-blue-600/20 p-4 rounded-lg text-blue-400 border border-blue-600 w-16 h-16 flex items-center justify-center">
//                   <Mail size={28} />
//                 </div>
//                 <div>
//                   <h3 className="text-xl font-semibold text-slate-100 mb-1">Email</h3>
//                   <a href={`mailto:${personalInfo.email}`} className="text-lg text-slate-300 hover:text-blue-400 transition-colors duration-300">
//                     {personalInfo.email}
//                   </a>
//                 </div>
//               </div>
...
//                 </div>
//                 <div>
//                   <h3 className="text-xl font-semibold text-slate-100 mb-1">Phone</h3>
//                   <a href={`https://wa.me/${personalInfo.phone.replace(/\\D/g, '')}`} target="_blank" rel="noopener noreferrer" className="text-lg text-slate-300 hover:text-blue-400 transition-colors duration-300">
//                     {personalInfo.phone}
//                   </a>
//                 </div>
//               </div>
...
//                   <p className="text-lg text-slate-300">{personalInfo.location}</p>
//                 </div>
//               </div>
//             </div>
//             <div>
//               <h3 className="mb-8 text-2xl font-bold text-slate-100">Connect With Me</h3>
//               <div className="flex flex-col gap-6 max-w-xs">
//                 <a href={personalInfo.linkedin} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-3 px-6 py-3 rounded-lg border border-blue-600 bg-blue-600/10 text-blue-400 font-semibold hover:bg-gradient-to-r hover:from-blue-500 hover:to-cyan-500 hover:text-white hover:shadow-lg transition-all duration-300">
//                   <Linkedin size={24} className="group-hover:text-white" /> LinkedIn
//                 </a>
//                 <a href={personalInfo.github} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-3 px-6 py-3 rounded-lg border border-blue-600 bg-blue-600/10 text-blue-400 font-semibold hover:bg-gradient-to-r hover:from-blue-500 hover:to-cyan-500 hover:text-white hover:shadow-lg transition-all duration-300">
//                   <Github size={24} className="group-hover:text-white" /> GitHub
//                 </a>
//               </div>
//             </div>
//           </div>
...
//         <div className="max-w-7xl mx-auto">
//           <p className="text-base mb-2 text-slate-200">&copy; {new Date().getFullYear()} {personalInfo.name}. All rights reserved.</p>
...
//       {showScrollTop && (
//         <button className="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-full flex items-center justify-center shadow-lg shadow-blue-500/40 hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-500/50 transition-all z-999 animate-fadeInUp" onClick={scrollToTop} aria-label="Scroll to top">
//           <ArrowUp size={20} />
//         </button>
//       )}
...
//         @keyframes slideBackground { 0% { background-position: 0 0; } 100% { background-position: 0 -400px; } }
//         .experience-line {
