...
//   if (isLoading) {
//     return (
//       <div className="fixed inset-0 bg-gradient-to-br from-purple-600 to-indigo-800 flex items-center justify-center z-[9999]">
...
//           <div className="flex items-center gap-2.5 text-2xl font-bold text-purple-500">
...
//                     activeSection === item.id ? 'text-purple-500' : 'text-slate-400 hover:text-purple-500'
//                   }`}
//                 >
//                   {item.name}
//                   {activeSection === item.id && (
//                     <span className="absolute -bottom-1 left-0 right-0 h-0.5 bg-gradient-to-r from-purple-500 to-violet-600 rounded-full"></span>
//                   )}
//                 </button>
//               </li>
//             ))}
...
//           <div className="absolute w-[300px] h-[300px] bg-purple-500/10 rounded-full -top-24 -right-24 animate-float"></div>
//           <div className="absolute w-[200px] h-[200px] bg-purple-500/10 rounded-full bottom-12 -left-12 animate-float-reverse"></div>
//           <div className="absolute w-[150px] h-[150px] bg-purple-500/10 rounded-full top-1/2 left-[10%] animate-float"></div>
//         </div>
        
//         <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-16 items-center relative z-10">
//           <div className="text-center lg:text-left">
//             <p className="text-xl font-medium mb-2.5 text-slate-400 opacity-90 animate-fadeInUp">Hello, I'm</p>
...
//               <h2 className="text-3xl md:text-4xl font-semibold bg-gradient-to-r from-purple-500 to-violet-600 bg-clip-text text-transparent animate-fadeInUp" style={{ animationDelay: '0.4s', animationFillMode: 'both' }}>
//                 {typedRole}
//                 <span className={`ml-0.5 transition-opacity duration-100 text-purple-500 ${cursorVisible ? 'opacity-100' : 'opacity-0'}`}>|</span>
//               </h2>
//             </div>
...
//                 download 
//                 className="inline-flex items-center justify-center gap-2 px-7 py-3.5 text-base font-semibold rounded-full bg-gradient-to-r from-purple-500 to-violet-600 text-white hover:-translate-y-0.5 hover:shadow-lg hover:shadow-purple-500/40 transition-all"
//               >
//                 <Download size={18} />
//                 Download CV
//               </a>
...
//                 className="inline-flex items-center justify-center gap-2 px-7 py-3.5 text-base font-semibold rounded-full bg-purple-500/10 text-purple-500 border-2 border-purple-500/30 hover:bg-purple-500/20 hover:-translate-y-0.5 transition-all"
//               >
//                 Get in Touch
...
//               <a href={`mailto:${personalInfo.email}`} className="w-11 h-11 flex items-center justify-center bg-purple-500/10 rounded-full text-purple-500 border border-purple-500/20 hover:bg-gradient-to-r hover:from-purple-500 hover:to-violet-600 hover:text-white hover:-translate-y-1 hover:shadow-md hover:shadow-purple-500/30 transition-all" aria-label="Email">
//                 <Mail size={20} />
//               </a>
//               <a href={personalInfo.linkedin} target="_blank" rel="noopener noreferrer" className="w-11 h-11 flex items-center justify-center bg-purple-500/10 rounded-full text-purple-500 border border-purple-500/20 hover:bg-gradient-to-r hover:from-purple-500 hover:to-violet-600 hover:text-white hover:-translate-y-1 hover:shadow-md hover:shadow-purple-500/30 transition-all" aria-label="LinkedIn">
//                 <Linkedin size={20} />
//               </a>
//               <a href={personalInfo.github} target="_blank" rel="noopener noreferrer" className="w-11 h-11 flex items-center justify-center bg-purple-500/10 rounded-full text-purple-500 border border-purple-500/20 hover:bg-gradient-to-r hover:from-purple-500 hover:to-violet-600 hover:text-white hover:-translate-y-1 hover:shadow-md hover:shadow-purple-500/30 transition-all" aria-label="GitHub">
//                 <Github size={20} />
//               </a>
//             </div>
//           </div>
...
//             <div className="w-full max-w-md aspect-square bg-purple-500/5 rounded-3xl flex items-center justify-center border-2 border-purple-500/20 animate-pulse-slow">
//               <Code size={80} className="text-purple-500/50" />
//             </div>
//           </div>
//         </div>
...
//           <div className="w-6 h-10 border-2 border-purple-500 rounded-2xl relative">
//             <div className="w-1 h-2 bg-purple-500 rounded-sm absolute top-2 left-1/2 -translate-x-1/2 animate-scroll"></div>
//           </div>
...
//             <div className="text-center">
//               <p className="text-xl md:text-2xl font-semibold text-purple-500 mb-5 leading-relaxed">{professionalSummary.intro}</p>
//               <p className="text-lg leading-relaxed text-slate-400 mb-10">{professionalSummary.about}</p>
              
//               <div className="grid md:grid-cols-3 gap-8">
//                 <div className="flex gap-4 p-5 bg-slate-900 rounded-xl border border-purple-500/10 hover:-translate-y-1 hover:border-purple-500/30 hover:shadow-lg hover:shadow-black/30 transition-all">
...
//               <div key={index} className="p-10 bg-slate-950 rounded-2xl text-center border border-purple-500/10 hover:-translate-y-2 hover:border-purple-500/30 hover:shadow-xl hover:shadow-black/30 transition-all group">
//                 <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-r from-purple-500 to-violet-600 rounded-2xl flex items-center justify-center group-hover:rotate-y-180 transition-transform duration-500">
...
//             <div className="bg-slate-900 p-8 rounded-2xl border border-purple-500/10 hover:border-purple-500/30 hover:-translate-y-1 hover:shadow-lg hover:shadow-black/30 transition-all">
...
//                   <span key={index} className="px-5 py-2.5 bg-purple-500/10 rounded-full text-sm font-medium border border-purple-500/20 text-slate-200 hover:bg-gradient-to-r hover:from-purple-500 hover:to-violet-600 hover:text-white hover:-translate-y-0.5 hover:shadow-md hover:shadow-purple-500/30 transition-all cursor-default">
//                     {skill}
//                   </span>
//                 ))}
//               </div>
...
//             <div className="md:col-span-2 bg-slate-900 p-8 rounded-2xl border border-purple-500/10 hover:border-purple-500/30 hover:-translate-y-1 hover:shadow-lg hover:shadow-black/30 transition-all">
//               <h3 className="flex items-center gap-3 text-xl font-bold mb-5 text-slate-100">
//                 <Code size={24} />
//                 Core Concepts
//               </h3>
...
//             <div className="absolute left-8 md:left-12 top-0 bottom-0 w-0.5 bg-gradient-to-b from-purple-500 to-violet-600"></div>
            
//             {experience.map((exp, index) => (
//               <div key={index} className="relative pl-20 md:pl-32 mb-12 last:mb-0">
//                 <div className="absolute left-5 md:left-9 w-10 h-10 bg-gradient-to-r from-purple-500 to-violet-600 rounded-full flex items-center justify-center text-white shadow-lg shadow-purple-500/40">
//                   <Briefcase size={20} />
//                 </div>
//                 <div className="bg-slate-950 p-8 rounded-2xl border border-purple-500/10 hover:-translate-y-1 hover:border-purple-500/30 hover:shadow-lg hover:shadow-black/30 transition-all">
...
//                     </span>
//                   </div>
//                   <p className="text-base text-purple-500 font-semibold mb-5">{exp.company} • {exp.location}</p>
//                   <ul className="list-none p-0">
//                     {exp.highlights.map((highlight, idx) => (
//                       <li key={idx} className="pl-6 mb-3 text-slate-400 leading-relaxed relative before:content-['▹'] before:absolute before:left-0 before:text-purple-500 before:font-bold">
//                         {highlight}
//                       </li>
//                     ))}
//                   </ul>
...
//               <div key={index} className="bg-slate-900 p-10 rounded-2xl text-center border border-purple-500/10 hover:-translate-y-2 hover:border-purple-500/30 hover:shadow-xl hover:shadow-black/30 transition-all">
//                 <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-r from-purple-500 to-violet-600 rounded-full flex items-center justify-center text-white">
//                   <GraduationCap size={40} />
//                 </div>
//                 <h3 className="text-xl font-bold text-slate-100 mb-4 leading-snug">{edu.degree}</h3>
//                 <p className="text-base text-purple-500 font-semibold mb-2.5">{edu.institution}</p>
...
//                     <li key={idx} className="pl-6 mb-2.5 text-slate-400 leading-relaxed relative text-sm before:content-['▹'] before:absolute before:left-0 before:text-purple-500 before:font-bold">
//                       {highlight}
//                     </li>
//                   ))}
//                 </ul>
...
//               <div key={index} className="bg-slate-950 p-9 rounded-2xl border border-purple-500/10 hover:-translate-y-2 hover:border-purple-500/30 hover:shadow-xl hover:shadow-black/30 transition-all">
//                 <div className="flex justify-between items-center mb-5">
//                   <span className="text-xs font-semibold text-purple-500 bg-purple-500/10 px-3 py-1.5 rounded-full border border-purple-500/20">
//                     {project.category}
//                   </span>
//                   <div className="flex gap-2.5">
//                     {project.github && (
//                       <a href={project.github} target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center bg-purple-500/10 rounded-full text-purple-500 border border-purple-500/20 hover:bg-gradient-to-r hover:from-purple-500 hover:to-violet-600 hover:text-white hover:-translate-y-0.5 hover:shadow-md hover:shadow-purple-500/30 transition-all" aria-label="GitHub">
//                         <Github size={18} />
//                       </a>
//                     )}
//                     {project.live && (
//                       <a href={project.live} target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center bg-purple-500/10 rounded-full text-purple-500 border border-purple-500/20 hover:bg-gradient-to-r hover:from-purple-500 hover:to-violet-600 hover:text-white hover:-translate-y-0.5 hover:shadow-md hover:shadow-purple-500/30 transition-all" aria-label="Live Demo">
...
//                     <span key={idx} className="text-[13px] px-3 py-1.5 bg-purple-500/10 text-slate-200 rounded-2xl font-medium border border-purple-500/20">
//                       {tech}
//                     </span>
//                   ))}
//                 </div>
...
//                 {project.highlights && (
//                   <ul className="list-none p-0 border-t border-purple-500/10 pt-5">
...
//               <div key={index} className="bg-slate-900 p-9 rounded-2xl text-center border border-purple-500/10 hover:-translate-y-2 hover:border-purple-500/30 hover:shadow-xl hover:shadow-black/30 transition-all">
...
//                 <p className="text-[15px] text-purple-500 font-semibold mb-2">{cert.issuer}</p>
...
//                 <div className="w-12 h-12 bg-purple-500/10 rounded-xl flex items-center justify-center flex-shrink-0 text-purple-500 border border-purple-500/20">
//                   <Mail size={24} />
//                 </div>
//                 <div>
//                   <h3 className="text-lg font-semibold mb-2 text-slate-100">Email</h3>
//                   <a href={`mailto:${personalInfo.email}`} className="text-base text-slate-400 hover:text-purple-500 transition-colors">
//                     {personalInfo.email}
//                   </a>
//                 </div>
//               </div>
...
//                   <a href={`tel:${personalInfo.phone}`} className="text-base text-slate-400 hover:text-purple-500 transition-colors">
//                     {personalInfo.phone}
//                   </a>
//                 </div>
//               </div>
...
//             <div className="bg-purple-500/5 p-10 rounded-2xl border border-purple-500/10">
//               <form className="flex flex-col gap-6">
//                 <div className="flex flex-col gap-2">
//                   <label htmlFor="name" className="text-sm font-semibold text-slate-200">Name</label>
//                   <input type="text" id="name" name="name" required placeholder="Your Name" className="px-5 py-3.5 border border-purple-500/20 rounded-lg text-base bg-slate-950/50 text-slate-200 placeholder:text-slate-600 focus:outline-none focus:border-purple-500 focus:bg-slate-950/80 transition-all" />
//                 </div>

//                 <div className="flex flex-col gap-2">
//                   <label htmlFor="email" className="text-sm font-semibold text-slate-200">Email</label>
//                   <input type="email" id="email" name="email" required placeholder="your.email@example.com" className="px-5 py-3.5 border border-purple-500/20 rounded-lg text-base bg-slate-950/50 text-slate-200 placeholder:text-slate-600 focus:outline-none focus:border-purple-500 focus:bg-slate-950/80 transition-all" />
//                 </div>

//                 <div className="flex flex-col gap-2">
//                   <label htmlFor="subject" className="text-sm font-semibold text-slate-200">Subject</label>
//                   <input type="text" id="subject" name="subject" required placeholder="Project Inquiry" className="px-5 py-3.5 border border-purple-500/20 rounded-lg text-base bg-slate-950/50 text-slate-200 placeholder:text-slate-600 focus:outline-none focus:border-purple-500 focus:bg-slate-950/80 transition-all" />
//                 </div>

//                 <div className="flex flex-col gap-2">
//                   <label htmlFor="message" className="text-sm font-semibold text-slate-200">Message</label>
//                   <textarea id="message" name="message" rows="5" required placeholder="Your message here..." className="px-5 py-3.5 border border-purple-500/20 rounded-lg text-base bg-slate-950/50 text-slate-200 placeholder:text-slate-600 focus:outline-none focus:border-purple-500 focus:bg-slate-950/80 transition-all resize-vertical font-sans"></textarea>
//                 </div>

//                 <button type="submit" className="inline-flex items-center justify-center gap-2 px-7 py-3.5 text-base font-semibold rounded-full bg-gradient-to-r from-purple-500 to-violet-600 text-white hover:-translate-y-0.5 hover:shadow-lg hover:shadow-purple-500/40 transition-all w-full">
//                   Send Message
//                   <ChevronRight size={18} />
//                 </button>
//               </form>
...
//       {/* Footer */}
//       <footer className="bg-slate-950/60 text-slate-400 py-10 px-5 text-center border-t border-purple-500/10">
//         <div className="max-w-7xl mx-auto">
...
//       {showScrollTop && (
//         <button 
//           className="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-r from-purple-500 to-violet-600 text-white rounded-full flex items-center justify-center shadow-lg shadow-purple-500/40 hover:-translate-y-1 hover:shadow-xl hover:shadow-purple-500/50 transition-all z-[999] animate-fadeInUp"
//           onClick={scrollToTop}
